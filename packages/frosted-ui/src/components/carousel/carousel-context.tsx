...
function useScrollGalleryContext(): CarouselContextValue {
  const context = React.useContext(CarouselContext);
  if (context === undefined) {
    throw new Error('Carousel compound components must be used within a Carousel.Root');
  }
  return context;
}
 ...
 * `scroll-behavior: auto` rule in carousel.css — the CSS property
...
export type { ChangeSource, CarouselContextValue };
