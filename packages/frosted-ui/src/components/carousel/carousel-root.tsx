...
interface CarouselRootProps {
   ...
   */
  onValueChange?: (value: number, metadata: { source: ChangeSource }) => void;
  /**
...
/**
 * Imperative handle exposed via `ref` on Carousel.Root.
 *
 ...
 *     {images.map((src, i) => (
 *       <Carousel.ScrollMarker key={src} index={i} aria-label={`Go to item ${i + 1}`} />
 *     ))}
 *   </Carousel.ScrollMarkerGroup>
 * </Carousel.Root>
 */
...
export { CarouselRoot };
export type { CarouselRootProps, CarouselRootRef };
