...
import { Callout, Code, Link, Text } from '..';
  ...
  'Action disabled'() {
    ...
    return (
      <>
        <div style={{ maxWidth: 500, marginBottom: 'var(--space-4)' }}>
          <Text>
            Use the <Code>disabled</Code> prop on <Code>Callout.Action</Code> to prevent interaction, for example while
            a prerequisite step is incomplete.
          </Text>
        </div>
        <Callout.Root {...args}>
          <Callout.Icon>
      ...
      <>
        <div style={{ maxWidth: 500 }}>
          <Text>
            ...
            to the callout when the user's immediate attention is required, like when an error message appears. The
            screen reader will be interrupted, announcing the new content immediately.
          </Text>
        </div>
        <br />
