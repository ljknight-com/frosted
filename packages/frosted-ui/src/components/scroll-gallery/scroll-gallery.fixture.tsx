        ...
        <ScrollGallery.Root defaultValue={0} orientation="vertical">
          <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'var(--space-2)' }}>
              <ScrollGallery.Previous
                aria-label="Previous"
                render={<IconButton variant="soft" size="1" color="gray" />}
              >
                <ChevronUp size={16} />
              </ScrollGallery.Previous>
    ...
    return (
      <div style={{ maxWidth: 720 }}>
        <div style={{ marginBottom: 'var(--space-4)' }}>
          ...
          <Text render={<p />} size="2" color="gray" style={{ maxWidth: 560, lineHeight: 1.6 }}>
            Pass <Code size="2">step=&#123;1&#125;</Code> to the Previous and Next buttons to scroll by one item at a
            time instead of by page. You can also use <Code size="2">step=&#123;2&#125;</Code> or any number to skip
            multiple items.
          </Text>
        </div>
      ...
      <div style={{ maxWidth: 720 }}>
        <div style={{ marginBottom: 'var(--space-4)' }}>
          ...
          <Text render={<p />} size="2" color="gray" style={{ maxWidth: 560, lineHeight: 1.6 }}>
            ...
            viewport start, but without <Code size="2">scroll-snap-type</Code> the scroll position won't snap after a
            manual trackpad swipe.
          </Text>
        </div>
      ...
      <div style={{ maxWidth: 720 }}>
        <div style={{ marginBottom: 'var(--space-4)' }}>
          ...
          <Text render={<p />} size="2" color="gray">
            With <Code size="2">loop</Code> enabled, the Previous and Next buttons never disable. Clicking Next at the
            end wraps to the first item, and Previous at the start wraps to the last. Arrow keys on markers also wrap.
          </Text>
        </div>
