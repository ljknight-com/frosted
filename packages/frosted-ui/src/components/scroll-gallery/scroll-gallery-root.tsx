 ...
 * </ScrollGallery.Root>
 */
const ScrollGalleryRoot = React.forwardRef<ScrollGalleryRootRef, ScrollGalleryRootProps>(
  function ScrollGalleryRoot(props, forwardedRef) {
    ...
    return <ScrollGalleryContext.Provider value={contextValue}>{children}</ScrollGalleryContext.Provider>;
  },
);
