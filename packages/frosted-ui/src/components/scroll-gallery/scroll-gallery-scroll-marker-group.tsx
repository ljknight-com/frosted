...
interface ScrollGalleryScrollMarkerGroupProps extends useRender.ComponentProps<
  'div',
 ...
 */
const ScrollGalleryScrollMarkerGroup = React.forwardRef<HTMLDivElement, ScrollGalleryScrollMarkerGroupProps>(
...
export type { ScrollGalleryScrollMarkerGroupProps, ScrollGalleryScrollMarkerGroupState };
