...
interface ScrollGalleryScrollMarkerProps extends useRender.ComponentProps<'button', ScrollGalleryScrollMarkerState> {
  /**
 ...
 */
const ScrollGalleryScrollMarker = React.forwardRef<HTMLButtonElement, ScrollGalleryScrollMarkerProps>(
  function ScrollGalleryScrollMarker(props, forwardedRef) {
    ...
    const state = React.useMemo<ScrollGalleryScrollMarkerState>(() => ({ active: isActive, index }), [isActive, index]);
