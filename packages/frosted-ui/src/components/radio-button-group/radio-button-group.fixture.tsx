...
import { Avatar, Button, Card, RadioButtonGroup, Tooltip, Typography, radioGroupPropDefs } from '..';
...
export default {
  Default() {
    const props = useComponentControls('RadioButtonGroup.Root');
    return (
      <RadioButtonGroup.Root defaultValue="1" {...props}>
