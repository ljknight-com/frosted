...
import { Checkbox, Code, Em, Kbd, Link, Text, TextField } from '..';
import { useComponentControls } from '../../../cosmos/controls';

export default {
  Default() {
    const [children] = useFixtureInput('children', 'The quick brown fox jumps over the lazy dog.');
    const props = useComponentControls('Text');
