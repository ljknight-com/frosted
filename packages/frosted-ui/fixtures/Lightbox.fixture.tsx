...
import Demo from '../demos/lightbox.demo';
import {
  Avatar,
  Badge,
  Button,
...
import type { LightboxZoomRef } from '../src/components/lightbox/lightbox-zoom';
...
function WithScrollGalleryStory() {
...
function RealEstateListingStory() {
  const [activeIndex, setActiveIndex] = useState(0);
...
function DesignFileInspectorStory() {
  const [activeIndex, setActiveIndex] = useState(0);
...
function LifecycleCallbacksStory() {
...
const examples = {
  ...
  ImperativeAPI: ImperativeAPIStory,
  LazyLoading: LazyLoadingStory,
  WithScrollGallery: WithScrollGalleryStory,
  'Within Article': WithinArticleStory,
  'Social Feed': SocialFeedStory,
  'Real Estate Listing': RealEstateListingStory,
  'Color Palette': ColorPaletteStory,
  'Design File Inspector': DesignFileInspectorStory,
  'Film Trailers': FilmTrailersStory,
